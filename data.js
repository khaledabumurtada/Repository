...
const APPS = [
  {
    ...
    "article_ar": "Notion من أشهر أدوات تنظيم العمل والملاحظات بالعالم، وضافت ميزات ذكاء اصطناعي (Notion AI) قوية صارت تخليها أكتر من مجرد مكان لكتابة الملاحظات.\n\nالفكرة الأساسية إنك تبني بيها مساحة عمل كاملة — ملاحظات، جداول مهام، قواعد بيانات، تقويم مشاريع — كل هاد بمكان واحد وبشكل مرن تصمّمه متل ما بدك. مع تفعيل الذكاء الاصطناعي، تقدر تطلب منه يلخّصلك صفحة طويلة، يكتب مسودة أولى لأي محتوى، يصحّح لغتك، أو حتى يترجم نص كامل، وكل هاد جوا نفس الصفحة اللي عم تشتغل فيها.\n\nمثلاً فريق عمل عم يكتب تقرير اجتماع طويل، بيقدر يطلب من Notion AI يلخّصه بنقاط واضحة خلال ثواني بدل ما يقرأه كامل ويلخّصه يدويًا.\n\nNotion بحد ذاته مجاني للاستخدام الشخصي بميزات كافية، بس ميزات الذكاء الاصطناعي تحتاج اشتراك إضافي منفصل. كمان الأداة فيها منحنى تعلّم بالبداية لو بدك تستفيد من كل إمكانياتها بالتنظيم.\n\nلأي فريق أو شخص بدو مكان واحد منظّم لكل شغله مع مساعد ذكاء اصطناعي مدمج، Notion من أفضل الخيارات الشاملة الموجودة.",
    "article_en": "Notion is one of the world's most popular work and note-organizing tools, and its added AI features (Notion AI) have turned it into much more than just a place to jot down notes.\n\nThe core idea is building a complete workspace — notes, task boards, databases, project calendars — all in one place, structured however you like. With AI enabled, you can ask it to summarize a long page, draft a first version of any content, fix your grammar, or even translate a whole passage, all within the same page you're working on.\n\nFor example, a team writing up a long meeting report can ask Notion AI to summarize it into clear bullet points in seconds instead of reading through and summarizing it manually.\n\nNotion itself is free for personal use with plenty of features, but the AI features require a separate add-on subscription. There's also a bit of a learning curve at first if you want to make full use of its organizational power.\n\nFor any team or individual who wants one organized place for all their work with a built-in AI assistant, Notion is one of the best all-around options out there."
  },
  {
    "id": "ai-2",
    "category": "ai",
  ...
  },
  {
    ...
    "article_ar": "Runway من الأدوات الرائدة بتوليد وتحرير الفيديو بالذكاء الاصطناعي، ومستخدمة من صنّاع محتوى ومخرجين محترفين وشركات إنتاج فعلية، مش بس هواة.\n\nبتقدر تولّد فيديو كامل من وصف نصي بس (Text to Video)، أو تحوّل صورة ثابتة لفيديو متحرك، أو حتى تعدّل مقطع فيديو موجود عندك — تشيل الخلفية، تغيّر عنصر فيها، تطوّل أو تقصّر المشهد — كل هاد بالذكاء الاصطناعي بدون برامج مونتاج تقليدية معقّدة.\n\nمثلاً صانع إعلان بده لقطة منتج بزاوية معينة ما قدر يصورها، بيكتب وصف المشهد اللي بده إياه، وRunway تولّدله مقطع فيديو قصير يقدر يستخدمه مباشرة بالإعلان.\n\nالأداة قوية لكنها تقنية أكتر من أدوات الفيديو البسيطة، وبتحتاج وقت تتعلم فيها الأدوات المختلفة. النسخة المجانية محدودة جدًا بعدد الثواني اللي تقدر تولّدها، وللاستخدام الجدي لازم اشتراك مدفوع.\n\nإذا شغلك بمجال الإنتاج المرئي أو الإعلانات وبدك أدوات فيديو احترافية بالذكاء الاصطناعي، Runway من أقوى الخيارات المتاحة حاليًا.",
    "article_en": "Runway is one of the leading AI video generation and editing tools, used by content creators, professional directors, and actual production studios — not just hobbyists.\n\nYou can generate a full video from just a text description (text-to-video), turn a still image into a moving clip, or even edit an existing video — remove the background, change an element in it, extend or trim a scene — all with AI, without complex traditional editing software.\n\nFor example, an ad creator who couldn't shoot a product from a specific angle can describe the shot they want, and Runway generates a short video clip ready to use directly in the ad.\n\nThe tool is powerful but more technical than simple video apps, and takes some time to learn its various tools. The free tier is quite limited in generation seconds, and serious use requires a paid subscription.\n\nIf your work is in visual production or advertising and you want professional AI video tools, Runway is one of the strongest options currently available."
  },
  {
    "id": "ai-14",
    "category": "ai",
  ...
  },
  {
    ...
    "article_ar": "Suno AI أداة مذهلة بتخليك تولّد أغنية كاملة — كلمات، لحن، وصوت غناء — من مجرد وصف نصي بسيط، بدون ما تعرف تعزف أو تغني أو حتى تكتب كلمات أغنية.\n\nتكتبله وصف للأغنية اللي بدك إياها (النوع الموسيقي، الموضوع، الإحساس العام)، أو حتى تكتب كلماتك الخاصة وهو يلحّنها ويغنّيها، وخلال دقيقة أو دقيقتين عندك أغنية كاملة جاهزة بجودة صوت عالية وآلات موسيقية واقعية.\n\nمثلاً بدك أغنية عيد ميلاد مخصصة لصديقك باسمه، تكتب وصف بسيط (\"أغنية مرحة عن شخص اسمه أحمد بيحب كرة القدم\")، وSuno يولّدلك أغنية كاملة مخصصة خلال دقائق.\n\nالنسخة المجانية بتخليك تولّد عدد محدود من الأغاني يوميًا وبحقوق استخدام محدودة، والنسخة المدفوعة بتفتح عدد أكبر وحقوق استخدام تجاري لو بدك تستخدم الأغاني بمشاريعك.\n\nلصنّاع المحتوى اللي محتاجين موسيقى أصلية بدون تكلفة استوديو، أو حتى بس للمتعة، Suno تجربة ممتعة تستاهل التجربة.",
    "article_en": "Suno AI is an impressive tool that lets you generate a complete song — lyrics, melody, and vocals — from just a simple text description, without knowing how to play an instrument, sing, or even write lyrics.\n\nYou describe the song you want (genre, theme, overall vibe), or write your own lyrics and let it compose the melody and sing it, and within a minute or two you have a full song ready with high audio quality and realistic instrumentation.\n\nFor example, if you want a personalized birthday song for a friend, you write a short description (\"an upbeat song about someone named Ahmad who loves football\"), and Suno generates a complete custom song within minutes.\n\nThe free tier lets you generate a limited number of songs daily with limited usage rights; the paid tier unlocks more generations and commercial usage rights if you want to use the songs in your own projects.\n\nFor content creators who need original music without studio costs, or just for fun, Suno is a delightful experience worth trying."
  },
  {
    "id": "ai-26",
    "category": "ai",
  ...
  },
  {
    ...
    "article_ar": "Perplexity AI هو محرك بحث مبني على الذكاء الاصطناعي، بيجاوبك على أسئلتك بإجابة مباشرة وواضحة بدل ما يرميك بقائمة روابط تدوّر فيها بنفسك متل جوجل التقليدي.\n\nتكتبله سؤالك بلغة عادية، وهو يبحث بالإنترنت فعليًا (مش يجاوب من ذاكرته بس)، ويرجّعلك إجابة مباشرة مع ذكر المصادر اللي استند عليها بشكل واضح تحت كل جملة، فتقدر تتأكد من صحة المعلومة بنفسك لو حبيت.\n\nمثلاً لو بدك تعرف آخر تطورات موضوع معيّن هذا الأسبوع، بتسأله مباشرة، وهو يرجعلك ملخص محدّث بالمعلومة مع روابط المصادر، بدل ما تفتح 5 مواقع وتقارن بينهم بنفسك.\n\nالنسخة المجانية كافية جدًا للاستخدام اليومي العادي، والنسخة المدفوعة (Pro) بتفتح عدد بحث أكبر ونماذج ذكاء اصطناعي أقوى وميزات بحث متقدمة.\n\nلأي حد تعب من نتائج البحث التقليدية وبدو إجابات مباشرة وموثوقة بسرعة، Perplexity بديل ممتاز يستاهل التجربة.",
    "article_en": "Perplexity AI is an AI-powered search engine that gives you a direct, clear answer instead of throwing you a list of links to dig through yourself like traditional Google search.\n\nYou type your question in plain language, and it actually searches the live web (not just answering from memory), returning a direct answer with clearly cited sources under each claim, so you can verify the information yourself if you want.\n\nFor example, if you want to know the latest developments on a topic this week, you ask it directly and get an up-to-date summary with source links, instead of opening five websites and comparing them yourself.\n\nThe free tier is more than enough for regular daily use; the paid Pro tier unlocks more searches, stronger AI models, and advanced search features.\n\nFor anyone tired of traditional search results and wanting fast, direct, trustworthy answers, Perplexity is an excellent alternative worth trying."
  },
  {
    "id": "ai-40",
    "category": "ai",
    ...
    "article_ar": "Claude هو مساعد الذكاء الاصطناعي من شركة Anthropic، ومعروف بقدرته العالية على فهم النصوص الطويلة، الكتابة بأسلوب طبيعي ومتوازن، والمساعدة بمهام برمجية معقّدة.\n\nبتقدر تحكي معه بلغة عادية عن أي موضوع — تطلب منه يكتبلك مقال، يلخّص مستند طويل، يراجع كود برمجي ويصلح أخطاءه، أو حتى يرفعلك ملف PDF كامل ويجاوبك على أسئلة عنه. من مميزاته إنه بيقدر يتعامل مع نصوص طويلة جدًا بمرة وحدة بدون ما يفقد السياق.\n\nمثلاً مبرمج عالق بخطأ بالكود، بيلصق الكود كامل ويشرح المشكلة، وClaude يقرأ الكود، يحدد مكان الخطأ بالضبط، ويقترح الحل مع شرح ليش صار الخطأ من الأساس.\n\nالنسخة المجانية قوية وكافية لمعظم الاستخدامات اليومية، بس فيها حد أقصى للرسائل خلال فترة معينة، والنسخة المدفوعة (Pro) بتفتح استخدام أكبر ونماذج أقوى.\n\nلأي حد شغله يتطلب تحليل نصوص طويلة أو مساعدة برمجية دقيقة، Claude من أقوى المساعدين المتاحين حاليًا بالسوق.",
    "article_en": "Claude is Anthropic's AI assistant, known for its strong ability to understand long documents, write in a natural and balanced style, and help with complex coding tasks.\n\nYou can talk to it in plain language about anything — ask it to write an article, summarize a long document, review code and fix bugs, or even upload a full PDF and ask questions about it. One of its strengths is handling very long texts in a single pass without losing context.\n\nFor example, a developer stuck on a bug can paste the full code and explain the issue, and Claude reads through it, pinpoints exactly where the error is, and suggests a fix along with an explanation of why it happened in the first place.\n\nThe free tier is strong and covers most daily needs, though it has a message limit within a given time window; the paid Pro tier unlocks higher usage and more capable models.\n\nFor anyone whose work involves analyzing long documents or needs precise coding help, Claude is one of the strongest assistants currently available."
  },
  {
    "id": "ai-41",
    "category": "ai",
    ...
    "article_ar": "HeyGen أداة متخصصة بإنشاء فيديوهات فيها \"أفاتار\" ذكاء اصطناعي واقعي يتكلم بصوتك أو بأي صوت تختاره، وصارت مستخدمة بكثرة بالتدريب، التسويق، والتعليم عن بعد.\n\nبتقدر تختار من مكتبة أفاتارات جاهزة (شخصيات واقعية تتكلم عدة لغات) أو حتى ترفع فيديو قصير لنفسك وHeyGen تصنعلك أفاتار رقمي يشبهك، تكتبله أي نص وهو \"يتكلمه\" بحركة شفايف وتعابير وجه طبيعية جدًا.\n\nمثلاً شركة بدها فيديو تدريبي بعدة لغات لموظفيها بدون ما تصوّر بكل لغة، بتكتب النص وتختار اللغة، وHeyGen يولّدلها فيديو كامل بصوت وأفاتار واقعي بأي لغة تختارها.\n\nالنسخة المجانية محدودة جدًا بعدد الدقائق شهريًا، والاستخدام الجدي بحتاج اشتراك مدفوع، خصوصًا لو بدك تستخدم أفاتار مخصص من صورتك أو فيديوهاتك.\n\nلأي شركة أو صانع محتوى بدو فيديوهات احترافية بسرعة وبدون تصوير أو ممثلين، HeyGen توفّر وقت وتكلفة إنتاج كبيرة.",
    "article_en": "HeyGen is a tool specialized in creating videos with realistic AI avatars that speak in your voice or any voice you choose, widely used in training, marketing, and remote education.\n\nYou can pick from a library of ready avatars (realistic characters speaking multiple languages) or upload a short video of yourself and have HeyGen create a digital avatar that looks like you, then type any text and it \"speaks\" it with very natural lip movement and facial expressions.\n\nFor example, a company needing a multilingual training video for employees without filming in every language can write the script, pick the language, and HeyGen generates a full video with a realistic voice and avatar in whichever language they choose.\n\nThe free tier is quite limited in monthly minutes, and serious use requires a paid subscription, especially if you want a custom avatar made from your own photos or videos.\n\nFor any company or content creator who wants professional videos quickly without filming or actors, HeyGen saves significant time and production cost."
  },
  {
    "id": "ai-42",
    "category": "ai",
  ...
  },
  {
    ...
    "article_ar": "ElevenLabs هي الأداة الرائدة عالميًا بتحويل النص إلى صوت واقعي، ووصلت لمستوى جودة صعب تفرّق فيه بين الصوت المولّد بالذكاء الاصطناعي وصوت إنسان حقيقي.\n\nبتقدر تكتب أي نص وتختار من مكتبة أصوات جاهزة بلغات ولهجات مختلفة، أو حتى ترفع تسجيل صوتي قصير لصوتك أنت (أو صوت أي حد بإذنه) وتخلي الأداة \"تستنسخ\" هاد الصوت وتستخدمه لقراءة أي نص تاني. بتدعم العربية والإنجليزية وعشرات اللغات الثانية بجودة عالية.\n\nمثلاً صانع محتوى بده يعمل فويس أوفر لفيديو تعليمي بدون ما يسجّل صوته بنفسه، بيكتب السكريبت، يختار صوت مناسب، وخلال دقائق عنده ملف صوتي احترافي جاهز للفيديو.\n\nالنسخة المجانية محدودة بعدد الأحرف شهريًا، وميزة استنساخ الصوت الاحترافية (Voice Cloning) بتحتاج اشتراك مدفوع. كمان لازم تنتبه للاستخدام الأخلاقي — استنساخ صوت حد بدون إذنه مش صح ومخالف بمعظم الأماكن.\n\nلصانعي المحتوى، البودكاست، والفيديوهات التعليمية، ElevenLabs بتوفّر وقت وتكلفة تسجيل صوتي احترافي.",
    "article_en": "ElevenLabs is the world's leading AI text-to-speech tool, reaching a quality level where it's genuinely hard to tell an AI-generated voice apart from a real human one.\n\nYou can type any text and pick from a library of ready-made voices in different languages and accents, or even upload a short voice sample of your own (or anyone's, with permission) and have the tool \"clone\" that voice to read any other text. It supports Arabic, English, and dozens of other languages at high quality.\n\nFor example, a content creator who wants a voiceover for a tutorial video without recording their own voice can write the script, pick a suitable voice, and have a professional audio file ready in minutes.\n\nThe free tier has a monthly character limit, and the professional voice-cloning feature requires a paid subscription. It's also worth being mindful of ethical use — cloning someone's voice without their consent is wrong and against policy in most places.\n\nFor content creators, podcasters, and tutorial makers, ElevenLabs saves both time and the cost of professional voice recording."
  },
  {
    "id": "audio-3",
    "category": "audio",
  ...
  },
  {
    ...
    "article_ar": "Canva حوّلت التصميم من مهارة تحتاج سنين تعلّم لشي أي حد يقدر يعمله بدقائق، وضافت أدوات ذكاء اصطناعي قوية صارت تسرّع العملية أكتر.\n\nبتقدر تبلّش من آلاف القوالب الجاهزة (بوستر، منشور سوشيال ميديا، عرض تقديمي، سيرة ذاتية) وتعدّل عليها بالسحب والإفلات بدون أي خبرة تصميم. ميزات الذكاء الاصطناعي فيها بتخليك تولّد صور من نص، تشيل خلفية صورة بضغطة وحدة، أو حتى تطلب منها تصميم كامل من وصف بسيط وهي تقترحلك نسخة جاهزة.\n\nمثلاً صاحب متجر صغير بده منشور إنستغرام لعرض جديد، بيختار قالب مناسب، يبدّل النص والصور بمنتجه، وخلال دقائق عنده تصميم احترافي جاهز للنشر بدون ما يحتاج مصمم.\n\nالنسخة المجانية غنية جدًا وكافية لمعظم الاستخدامات الشخصية والتجارية الصغيرة، والنسخة المدفوعة (Pro) بتفتح قوالب وأدوات ذكاء اصطناعي إضافية ومساحة تخزين أكبر.\n\nلأي حد بدو يصمم محتوى بصري احترافي بدون خبرة تصميم أو وقت طويل، Canva تبقى الخيار الأسهل والأشمل بالسوق.",
    "article_en": "Canva turned design from a skill that takes years to learn into something anyone can do in minutes, and its added AI tools now speed things up even further.\n\nYou can start from thousands of ready templates (posters, social media posts, presentations, resumes) and customize them with simple drag-and-drop, no design experience needed. Its AI features let you generate images from text, remove a photo's background in one click, or even ask for a full design from a simple description and get a ready version suggested back.\n\nFor example, a small shop owner needing an Instagram post for a new offer can pick a suitable template, swap in their own text and product photos, and have a professional design ready to publish within minutes — no designer needed.\n\nThe free tier is quite generous and covers most personal and small-business needs; the paid Pro tier unlocks extra templates, AI tools, and more storage.\n\nFor anyone who needs professional-looking visual content without design experience or a lot of time, Canva remains the easiest and most complete option on the market."
  },
  {
    "id": "design-2",
    "category": "design",
  ...
  },
  {
    ...
    "article_ar": "Midjourney من أشهر أدوات توليد الصور الفنية بالذكاء الاصطناعي، ومعروف بجودة صوره العالية وطابعها الفني المميز اللي بصعب تميّزه أحيانًا عن رسم فنان حقيقي.\n\nتكتبله وصف نصي (برومبت) لأي صورة تتخيلها — شخصية، مشهد، تصميم منتج، لوحة فنية — وهو يولّدلك 4 نسخ مختلفة خلال ثواني، وتقدر تختار وحدة وتطوّرها أكتر (زوم، تعديل جزء منها، تكبير الدقة). كل ما كانت صياغة البرومبت أدق ووصفت الإضاءة والأسلوب والألوان، كانت النتيجة أقرب لتخيّلك.\n\nمثلاً مصمم غرافيك بده خلفية فنية لبوستر حفلة، بيكتب وصف قصير للأجواء والألوان المطلوبة، وخلال دقيقة عنده 4 خيارات جاهزة يختار منها بدل ما يرسم من الصفر.\n\nMidjourney ما عنده نسخة مجانية حاليًا، وبيشتغل بشكل أساسي عبر موقعه أو تطبيق Discord، وهاد ممكن يكون غريب شوي لأول مرة لحد مش متعوّد على Discord.\n\nلو شغلك يتطلب صور فنية عالية الجودة بشكل متكرر — تصميم، تسويق، محتوى — Midjourney من أقوى الخيارات المتاحة حاليًا بالسوق.",
    "article_en": "Midjourney is one of the most popular AI art generators, known for producing high-quality, distinctly artistic images that can sometimes be hard to tell apart from a human artist's work.\n\nYou write a text description (a prompt) of any image you imagine — a character, a scene, a product design, a painting — and it generates four different versions within seconds. You can then pick one and refine it further (zoom, edit a section, upscale resolution). The more precise your prompt — describing lighting, style, and colors — the closer the result gets to what you had in mind.\n\nFor example, a graphic designer needing an artistic poster background can write a short description of the mood and colors, and within a minute has four ready options to choose from instead of drawing from scratch.\n\nMidjourney currently has no free tier and works mainly through its website or the Discord app, which can feel a bit unfamiliar at first if you're not used to Discord.\n\nIf your work regularly needs high-quality artistic images — design, marketing, content — Midjourney is one of the strongest options available today."
  },
  {
    "id": "ai-new-chatgpt",
    "category": "ai",
    ...
    "article_ar": "ChatGPT من OpenAI هو المساعد الذي بدأ فعليًا موجة الذكاء الاصطناعي اللي كل العالم يحكي عنها هلق، وضل لهلق أكثر أداة استخدامًا بين مساعدي المحادثة بالعالم.\n\nالفكرة إنك تكتبله أي سؤال أو طلب بلغة عادية، وهو يفهمك ويردّلك بنص واضح ومنظّم — سواء كان السؤال معلومة بسيطة، مساعدة بكتابة إيميل، شرح مفهوم معقّد، أو حتى كتابة كود برمجي كامل. بيدعم اللغة العربية بشكل جيد كمان، وبيقدر يكمل معك محادثة طويلة ويتذكر السياق اللي حكيتوا فيه قبل شوي.\n\nمثلاً لو محتار كيف تكتب رسالة اعتذار مهنية لعميل، تشرحله الموقف بجملتين، وبيرجعلك مسودة جاهزة تقدر تعدّل عليها مباشرة بدل ما تفكّر من الصفر.\n\nالنسخة المجانية قوية جدًا وكافية لمعظم الاستخدامات اليومية، بس فيها حد أقصى للرسائل بالساعة، والنسخة المدفوعة (Plus) بتفتحلك نماذج أقوى وسرعة أعلى ووصول لتوليد الصور.\n\nإذا لسا ما جرّبت ChatGPT، هو نقطة انطلاق ممتازة لأي حد بدو يتعرف على الذكاء الاصطناعي، لأنه سهل وسريع ومفيد من أول استخدام.",
    "article_en": "ChatGPT by OpenAI is the assistant that effectively kicked off the AI wave everyone's talking about, and it remains the most widely used conversational AI assistant in the world.\n\nThe idea is simple: type any question or request in plain language, and it understands and replies with a clear, organized response — whether it's a quick fact, help drafting an email, explaining a complex idea, or even writing a full piece of code. It supports Arabic well too, and can hold a long conversation while remembering earlier context.\n\nFor example, if you're stuck writing a professional apology email to a client, describe the situation in a couple of sentences and it hands you a ready draft you can tweak directly instead of starting from scratch.\n\nThe free tier is strong and covers most daily needs, though it has an hourly message limit; the paid Plus tier unlocks more capable models, faster responses, and image generation.\n\nIf you haven't tried ChatGPT yet, it's an excellent starting point for anyone getting into AI — easy, fast, and useful from the very first message."
  },
  {
    "id": "ai-new-tome",
    "category": "ai",
